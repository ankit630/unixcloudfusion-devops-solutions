...
REGION="us-east-1"
eksctl create cluster --name $CLUSTER_NAME --version 1.30 --region $REGION --nodegroup-name standard-workers --node-type t3.medium --nodes 6 --nodes-min 1 --nodes-max 6 --managed --with-oidc
